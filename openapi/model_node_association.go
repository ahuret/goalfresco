...
// checks if the NodeAssociation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodeAssociation{}

// NodeAssociation struct for NodeAssociation
...
func (o NodeAssociation) MarshalJSON() ([]byte, error) {
...
func (o NodeAssociation) ToMap() (map[string]interface{}, error) {
...
type NullableNodeAssociation struct {
	value *NodeAssociation
	isSet bool
}

func (v NullableNodeAssociation) Get() *NodeAssociation {
	return v.value
}

func (v *NullableNodeAssociation) Set(val *NodeAssociation) {
	v.value = val
	v.isSet = true
}

func (v NullableNodeAssociation) IsSet() bool {
	return v.isSet
}

func (v *NullableNodeAssociation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNodeAssociation(val *NodeAssociation) *NullableNodeAssociation {
	return &NullableNodeAssociation{value: val, isSet: true}
}

func (v NullableNodeAssociation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNodeAssociation) UnmarshalJSON(src []byte) error {
	v.isSet = true
